...
(function (root) {
  ...
  var SESSIONS_LEGACY_FIELDS = [
    ...
    // CASE_SAVE_CYCLE_FIX_2026 — B1: حقل إضافي بحت، يُملأ فقط عند
    // الإنشاء المضمّن من شاشة القضية (js/modules/sessions.js). سجلات
    // قديمة/مستقلة بلا هذا الحقل تبقى صالحة (تعامل Repository.js مع أي
    // حقل غائب كنص فارغ افتراضيًا فى الفلترة/البحث).
    'رقم_الدعوى'
  ];
